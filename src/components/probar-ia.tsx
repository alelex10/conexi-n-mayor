...
const FALLBACK_MODELS: GroqModelUI[] = [
  {
    ...
    description: "Recomendado — Qwen 3.6 27B con visión nativa, rápido y económico (reemplaza Scout deprecado 17/07/2026)",
  ...
  },
  {
    ...
    description: "Qwen 3.8 27B — visión nativa, contexto largo",
    contextWindow: 131072,
    maxImages: 3,
    speed: "~500 TPS",
    pricingIn: "$0.80 / 1M",
  ...
  },
  {
    ...
    description: "Fallback texto — sin visión, solo referencia",
    contextWindow: 131072,
    maxImages: null,
    speed: "~400 TPS",
    pricingIn: "$0.15 / 1M",
