...
What will live here:
- `harness.ts` — JSON fence stripping, global confidence computation, and eventually shared Zod schemas + prompt builders (currently still owned by `groq/search.ts`; see TODOs inside).
